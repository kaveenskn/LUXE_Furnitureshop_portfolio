...
const InfoRow = ({ icon, label, children }) => (
  <div style={{
    ...
    <div>
      ...
      <div className="smoky-text" style={{
      ...
      <div className="cx-page" ref={container}>
        <div className="cx-body">
          ...
          <div className="cx-left">
            ...
            <p className="smoky-text" style={{
              margin: '0 0 32px', fontSize: '1.05rem',
            ...
            <div className="cx-info-row"><InfoRow icon={IcoPin} label="Studio">
              No. 124, Galle Road, Suite 400<br />
            ...
            <form onSubmit={e => e.preventDefault()}
              ...
              <div className="cx-field"><Field label="Project Type">
                <div style={{ position: 'relative' }}>
                  <select className="cx-select"
                    style={{
                      ...lineInput, appearance: 'none', WebkitAppearance: 'none',
              ...
              <div className="cx-field"><Field label="Message">
                <textarea rows={3} placeholder="Tell us about your project..."
                  className="cx-ta"
                  style={{
                    ...lineInput, resize: 'none', borderBottom: 'none',
